    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental >= 160 && frecuenciaFundamental <= 167)
                {
                    lblNota.Text = "E/Fb Small";
                }

                if (frecuenciaFundamental >= 171 && frecuenciaFundamental <= 177)
                {
                    lblNota.Text =  "E#/F Small";
                }

                if (frecuenciaFundamental >= 183 && frecuenciaFundamental <= 188)
                {
                    lblNota.Text =  "F#/Gb Small";
                }
                if (frecuenciaFundamental >= 193 && frecuenciaFundamental <= 199)
                {
                    lblNota.Text =  "G Small";
                }
                if (frecuenciaFundamental >= 204 && frecuenciaFundamental <= 210)
                {
                    lblNota.Text =  "G#Ab Small";
                }
                if (frecuenciaFundamental >= 217 && frecuenciaFundamental <= 223)
                {
                    lblNota.Text = "A Small";
                }
                if (frecuenciaFundamental >= 230 && frecuenciaFundamental <= 236)
                {
                    lblNota.Text =  "A#/Bb Small";
                }
                if (frecuenciaFundamental >= 243 && frecuenciaFundamental <= 249)
                {
                    lblNota.Text =  "B/Cb Small";
                }
                if (frecuenciaFundamental >= 258 && frecuenciaFundamental <= 264)
                {
                    lblNota.Text =  "B#/C One-Lined";
                }
                if (frecuenciaFundamental >= 274 && frecuenciaFundamental <= 280)
                {
                    lblNota.Text = "C#/Db One-Lined";
                }
                if (frecuenciaFundamental >= 290 && frecuenciaFundamental <= 296)
                {
                    lblNota.Text =  "D One-Lined";
                }
                if (frecuenciaFundamental >= 308 && frecuenciaFundamental <= 314)
                {
                    lblNota.Text =  "D#/Eb One-Lined";
                }
                if (frecuenciaFundamental >= 326 && frecuenciaFundamental <= 332)
                {
